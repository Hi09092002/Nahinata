    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          answerImg: [],
          answer:
            '（3）エネルギー源が過剰な時、細胞内 ATP 濃度が上昇し、TCA 回路はイソクエン酸からαケトグルタル酸への反応で阻害されるためにクエン酸が蓄積する。 これらのクエン酸は細胞質へ輸送された後、オキサロ酢酸とアセチルCoAに分解される。 このように生成されたアセチルCoAがカルボキシル化され、マロニルCoAとなる。 このようにして脂肪酸合成酵素の基質であるマロニルCoAが得られる。',
          commentary: '',
        },
        {
          detailInfo: '4',
