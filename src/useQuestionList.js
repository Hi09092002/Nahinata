      ...
      groupContents: [
        {
          ...
          commentary:
            'ビタミンB12の吸収には、胃の壁細胞から分泌される内因子が必要で、全摘によって内因子が分泌されなくなる。ビタミンB12の欠乏症は、悪性貧血の他に、神経障害、メチルマロン酸血症（尿症）、高ホモシステイン血症がある。　ちなみに、THFが必要となるのはUTP→TTP（チミン）の合成だけである。',
        },
        {
          detailInfo: '2',
          questionImg: [],
    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          commentary:
            'コロナウイルスはHIVなどとおなじレトロウイルスで、自身のRNAを宿主細胞のDNAに逆転写することができる。逆転写した後は宿主細胞の転写・翻訳機構を利用して増殖していく。',
        },
        {
          detailInfo: '8',
          questionImg: [],
          ...
          commentary:
            'コロナウイルスはRNAウイルスなので、まずcDNAに逆転写してからPCRで増幅する必要がある。実際のRT-PCRではこれをシークエンスするか、コロナウイルスの塩基配列に特異的に結合するプローブに蛍光色素をつけた試薬(Taqman法)で存在を調べる方法などが考えられる→特別講義「個人差の生化学」参考。実習の方法を使うのであればコロナウイルスに特異的な塩基配列を切断する制限酵素を探さなければいけない。コロナウイルスはレトロウイルスであるため逆転写酵素の精度が悪く、様々な変異があることも問題になる。',
        },
        {
          detailInfo: '9',
          questionImg: [],
