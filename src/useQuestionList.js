    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          commentary: 'HDLにもLDLにも存在する。LDLのほうが濃度は高い。',
        },
        {
          detailInfo: '4(2)',
          questionImg: [],
        ...
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '（3）LDL受容体が細胞内に取り込まれるのはどんな場合か?また、その機構について説明せよ。 （4）スタチン系治療薬Aが血中コレステロール濃度を下げる機構について説明せよ。',
          choices: [],
        ...
        },
        {
          ...
          answer:
            '（4）アセチルCoAからコレステロールが生成される過程で、HMG-CoA が酵素である HMG-CoAリダクターゼによりメバロン酸へ変換される。スタチン系治療薬 A は、HMG-CoA リダクターゼの競合阻害剤としてこの反応を阻害することで、血中コレステロール濃度を下 げる。',
          commentary: 'HMG-CoAリダクターゼが律速酵素',
        },
        {
          detailInfo: '5',
          questionImg: [],
          ...
          answer:
            '転写の開始は，TATA ボックスや CAAT ボックス，GC ボックスといったコンセンサス配列を含むプロモーター領域に基本転写因子と呼ばれるタンパク質が結合することによって起こる.続いて基本転写因子同士や基本転写因子とRNAポリメラーゼIIが結合する.RNA ポリメラーゼによってDNA配列の転写産物が合成され始め伸張していくがその方向は 5’ から 3’方向である.DNA 配列の中にはエンハンサーと呼ばれるものがあり，ここにあくち ベーターと呼ばれる転写因子が結合することによって転写開始の効率は上がる.こうして できた mRNA前駆体はその後，転写後修飾を受ける.具体的には 5’末端へのキャップ構造の付加と3’末端へのポリ A テール付加である.そしてイントロンを除去してエキソンを繋 ぎ合わせるスプライシングの過程を経て mRNAが完成する.',
          commentary: '',
        },
        {
          detailInfo: '6',
    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '（3）ヒトにおいてエネルギー源が過剰な時、トリアシルグリセロールが合成されて脂肪組織 に蓄えられるが、この過剰なエネルギー源はどのようにして脂肪酸合成酵素の基質になるか説明しなさい。',
          choices: [],
          answerImg: [],
          answer:
            '（3）エネルギー源が過剰な時、細胞内 ATP 濃度が上昇し、TCA 回路はイソクエン酸からαケトグルタル酸への反応で阻害されるためにクエン酸が蓄積する。 これらのクエン酸は細胞質へ輸送された後、オキサロ酢酸とアセチル COA に分解される。 このように生成されたアセチル COA がカルボキシル化され、マロニル COA となる。 このようにして脂肪酸合成酵素の基質であるマロニル COA が得られる。',
          commentary: '',
        },
        {
          detailInfo: '4',
        ...
        },
        {
          ...
          answerImg: [],
          answer:
            'HIV ウイルスはヘルパーT細胞内に侵入し、逆転写酵素を使い自らのゲノミックRNAからDNAを逆転写により合成する。そのDNAをヘルパーT 細胞の持つDNAに組み込み、転 写することでRNAを産出し、このRNAの一部から翻訳によりウイルス構造蛋白質が作られ、また、遺伝情報の担体として産出されたRNAを使うことでウイルスが複製される。 HIV ウイルスの持つ逆転写酵素は正確性が低く、変異が入りやすいため、様々な性質を持った変異ウイルスが生じやすい。このことがワクチン開発を困難にしている。',
          commentary: '',
        },
      ],
    },
      ...
      groupContents: [
        {
          ...
          commentary:
            '例えばピルビン酸→（ピルビン酸デヒドロゲナーゼ複合体/PDH）→アセチルCoAがグルコースの異化経路であるのに対して、ピルビン酸→（ピルビン酸カルボキシラーゼ）→オキサロ酢酸(OAA)は同化経路（糖新生など）である。アセチルCoAの濃度が高いとピルビン酸カルボキシラーゼがアロステリックに活性化し同化反応が進み、アセチルCoAの濃度が低いと異化反応が進む。',
        },
        {
          detailInfo: '2',
          questionImg: [],
        ...
        },
        {
          ...
          answer:
            'まず、アセチルCoAは、グルコース、脂肪酸、糖原性アミノ酸、ケトン体を原料として合成される。グルコースは、解糖されてピルビン酸となり、このピルビン酸を基質としてアセ チルCoAが生成する。脂肪酸は、トリアシルグリセロール(TAG)の形で脂肪細胞に貯蔵されていたものが、分解されて血中に放出され、各組織でβ酸化を受けて多くのアセチルCoAとなる。糖原性アミノ酸の場合は、アミノ基を転移されて残った炭素骨格からアセチルCoAが合成される。これは主に肝臓で行われる。ケトン体は、飢餓時に肝臓でアセチルCoAから合成され、血中に放出され、各組織に取り込まれて再びアセチルCoAに戻される。 これにより、ケトン体からアセチルCoAが合成される。次に、アセチルCoAを原料として、脂肪酸、ケトン体、コレステロールが合成される。脂肪酸は、エネルギー過剰時にアセチルCoAを原料として肝臓で合成される。ケトン体は、 上記のように飢餓時に肝臓でアセチルCoAから合成される。コレステロールは全身の様々な組織で合成される。最後に、アセチルCoA自体は、TCAサイクルを回ることで、CO2とH2Oに分解され、排出される。(503字)',
          commentary: '',
        },
        {
          detailInfo: '4',
