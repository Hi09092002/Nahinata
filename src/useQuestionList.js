    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          commentary:
            'DNA模型の口頭試問で聞かれた人はその際の先生からのコメントを反映させた方が良いかもしれませんね。私は、どのような挙動をするかよりも定義が大事で、挙動は推測に過ぎず例外が出たらどうするんだ、と詰められました。',
        },
        {
          detailInfo: '7',
          questionImg: [],
          questionSentence: '半不連続的的複製について説明しなさい。',
          choices: [],
          answerImg: [],
          answer:
