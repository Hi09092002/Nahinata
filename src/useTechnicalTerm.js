...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    },
    {
      ...
      explanation:'水溶性ビタミンであるビタミンB12は胃壁細胞の内因子IFと結合して回腸から吸収され、体内で補酵素型の5’-デオキシアデノシルコバラミン、メチルコバラミンとなり、異性化反応・メチル基転移反応などの補酵素として機能する。他の水溶性ビタミンと異なり肝臓で貯蔵される。5’-デオキシアデノシルコバラミン→メチルマロニルCoAムターゼ（奇数炭素鎖脂肪酸の代謝）、メチルコバラミン→メチオニンシンターゼ（メチオニン代謝）。胃切除などによりビタミンB12が欠乏し、悪性貧血（巨赤芽球性貧血）・神経障害・高ホモシステイン血症（メチオニンシンターゼの活性低下）・メチルマロン酸血症を引き起こす。',
    },
    {
      term:['ビタミンC',"アスコルビン酸","ascorbic acid"],
      explanation:'水溶性ビタミンであるビタミンCはアスコルビン酸ともよばれ、強い還元力をもち、水様性抗酸化物質として還元当量の供与体としてはたらく。コラーゲン合成において重要な、Pro・Lys残基の水酸化反応に還元剤として働き、酵素活性を回復させる。食品中の鉄イオンを2価（Fe²⁺）に保つことで吸収を促進する作用ももつ。欠乏すると壊血病を発症し、易出血性・骨・筋の脆弱化を引き起こす。',
    },
    // {
    //   term:[''],
    //   explanation:'',
